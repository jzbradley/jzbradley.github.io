...
(function () {
    ...
    : (function () {
        ...
        function _safeSetDataURI(fSuccess, fFail) {
          ...
          if (self._bSupportDataURI === null) {
            ...
            elImg.onabort = fOnError;
            elImg.onerror = fOnError;
            elImg.onload = fOnSuccess;
            elImg.src =
        ...
        var Drawing = function (el, htOption) {
          ...
          this._bIsPainted = false;
          const elImg=this._elImage = document.createElement("img");
          this._elImage.alt = "Scan me!";
          this._elImage.style.display = "none";
          const elA=this._elDownload = document.createElement("a");
          this._elDownload.onclick=function(){
            elA.href=elImg.src;
            elA.download="qrcode.png";
            return true;
          }
          this._elDownload.appendChild(this._elImage);
          this._el.appendChild(this._elDownload);
  ...
  QRCode = function (el, vOption) {
    ...
    this.isAndroid = _getAndroid();
    this.target = el;
    this.generator = null;
    this.drawing = new Drawing(this.target, this.options);
  ...
  QRCode.prototype.makeCode = function (sText) {
    this.generator = new QRCodeModel(
      _getTypeNumber(sText, this.options.correctLevel),
      this.options.correctLevel
    );
    this.generator.addData(sText);
    this.generator.make();
    this.target.title = sText;
    this.drawing.draw(this.generator);
    this.makeImage();
  };
  ...
  QRCode.prototype.makeImage = function () {
    if (
      typeof this.drawing.makeImage == "function" &&
      (!this.isAndroid || this.isAndroid >= 3)
    ) {
      this.drawing.makeImage();
    }
  };
